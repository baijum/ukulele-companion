...
Tap the **gear icon** in the toolbar of any tab to open the Settings panel as a sheet. Here you can adjust tuning, theme, sound, and more. See the [Settings](08-settings.md) page for details.
